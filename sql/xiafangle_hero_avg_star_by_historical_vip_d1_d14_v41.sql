...
(
    SELECT
        ...
        CASE
            ...
            THEN '无获取'
            ELSE cast(round(avg(CASE WHEN t.days = 0 THEN t."玩家英雄星级" END), 2) AS varchar)
        END "D1平均星级",

        CASE
            WHEN count(CASE WHEN t.days = 1 THEN 1 END) = 0
            THEN '无获取'
            ELSE cast(round(avg(CASE WHEN t.days = 1 THEN t."玩家英雄星级" END), 2) AS varchar)
        END "D2平均星级",

        CASE
            WHEN count(CASE WHEN t.days = 2 THEN 1 END) = 0
            THEN '无获取'
            ELSE cast(round(avg(CASE WHEN t.days = 2 THEN t."玩家英雄星级" END), 2) AS varchar)
        END "D3平均星级",

        CASE
            WHEN count(CASE WHEN t.days = 3 THEN 1 END) = 0
            THEN '无获取'
            ELSE cast(round(avg(CASE WHEN t.days = 3 THEN t."玩家英雄星级" END), 2) AS varchar)
        END "D4平均星级",

        CASE
            WHEN count(CASE WHEN t.days = 4 THEN 1 END) = 0
            THEN '无获取'
            ELSE cast(round(avg(CASE WHEN t.days = 4 THEN t."玩家英雄星级" END), 2) AS varchar)
        END "D5平均星级",

        CASE
            WHEN count(CASE WHEN t.days = 5 THEN 1 END) = 0
            THEN '无获取'
            ELSE cast(round(avg(CASE WHEN t.days = 5 THEN t."玩家英雄星级" END), 2) AS varchar)
        END "D6平均星级",

        CASE
            WHEN count(CASE WHEN t.days = 6 THEN 1 END) = 0
            THEN '无获取'
            ELSE cast(round(avg(CASE WHEN t.days = 6 THEN t."玩家英雄星级" END), 2) AS varchar)
        END "D7平均星级",

        CASE
            WHEN count(CASE WHEN t.days = 7 THEN 1 END) = 0
            THEN '无获取'
            ELSE cast(round(avg(CASE WHEN t.days = 7 THEN t."玩家英雄星级" END), 2) AS varchar)
        END "D8平均星级",

        CASE
            WHEN count(CASE WHEN t.days = 8 THEN 1 END) = 0
            THEN '无获取'
            ELSE cast(round(avg(CASE WHEN t.days = 8 THEN t."玩家英雄星级" END), 2) AS varchar)
        END "D9平均星级",

        CASE
            WHEN count(CASE WHEN t.days = 9 THEN 1 END) = 0
            THEN '无获取'
            ELSE cast(round(avg(CASE WHEN t.days = 9 THEN t."玩家英雄星级" END), 2) AS varchar)
        END "D10平均星级",

        CASE
            WHEN count(CASE WHEN t.days = 10 THEN 1 END) = 0
            THEN '无获取'
            ELSE cast(round(avg(CASE WHEN t.days = 10 THEN t."玩家英雄星级" END), 2) AS varchar)
        END "D11平均星级",

        CASE
            WHEN count(CASE WHEN t.days = 11 THEN 1 END) = 0
            THEN '无获取'
            ELSE cast(round(avg(CASE WHEN t.days = 11 THEN t."玩家英雄星级" END), 2) AS varchar)
        END "D12平均星级",

        CASE
            WHEN count(CASE WHEN t.days = 12 THEN 1 END) = 0
            THEN '无获取'
            ELSE cast(round(avg(CASE WHEN t.days = 12 THEN t."玩家英雄星级" END), 2) AS varchar)
        END "D13平均星级",

        CASE
            WHEN count(CASE WHEN t.days = 13 THEN 1 END) = 0
            THEN '无获取'
            ELSE cast(round(avg(CASE WHEN t.days = 13 THEN t."玩家英雄星级" END), 2) AS varchar)
        END "D14平均星级"
