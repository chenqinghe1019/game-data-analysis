...
(
    SELECT
        ...
        CASE
            ...
            WHEN r."开放后7日活跃人数" = 0 THEN '开放后7日无活跃玩家'
            ELSE '可评估'
        END "购买评估状态",
        ...
        CASE
            WHEN r."开放后7日活跃人数" = 0 THEN NULL
            ELSE round(
                r."开放后7日付费人数" * 1.0000
                / nullif(r."开放后7日活跃人数", 0),
                4
            )
        END "开放后7日购买率",
    ...
    (
        ...
        (
            /*==============================================================
              A. 开放后7日活跃口径：用于购买率、付费人数占比
              例：D15开放，则D15-D21任意一天有in_out_log即算活跃
            ==============================================================*/
            SELECT
                o."product_type_one",
                o."product_type_two",
            ...
            (
                ...
                (
                    ...
                    (
                        ...
                        ON try_cast(e."product_id" AS bigint) = cfg."product_id"
                       AND cast(e."product_name" AS varchar) = cfg."product_name"
                    ...
                    WHERE e."$part_event" = 'pay_log'
                      ...
                      AND CASE
                              WHEN coalesce(try_cast(e."payment" AS double), 0) = 0
                                  THEN coalesce(try_cast(e."token_payment" AS double), 0)
                              ELSE coalesce(try_cast(e."payment" AS double), 0)
                          END > 0

                      AND (
                            coalesce(cast(e."product_type" AS varchar), '') <> '直充'
                            OR strpos(
                    ...
                    ON p."product_type_one" = cat."product_type_one"
                   AND p."product_type_two" = cat."product_type_two"
            ...
            (
                ...
                INNER JOIN ta.v_event_41 ae
                    ...
                    ON cast(ae."#account_id" AS varchar) = c."#account_id"

                   AND cast(ae."$part_date" AS date)
                       BETWEEN c."create_date"
                           AND current_date
               ...
               AND a."active_offset"
                    BETWEEN o."最早付费offset"
                        AND o."最早付费offset" + 6

            LEFT JOIN ta.v_event_41 e

                ON cast(e."#account_id" AS varchar) = a."#account_id"
            ...
            (
                ...
                ON try_cast(e."product_id" AS bigint) = ecfg."product_id"
               AND cast(e."product_name" AS varchar) = ecfg."product_name"
            ...
            /*==============================================================
              B. 对应成熟新增口径：用于LTV相关指标
              例：D15开放、观察D15-D21，则只取已成熟到D21的新增玩家；
                  小类金额取D15-D21；总LTV金额取D1-D21。
            ==============================================================*/
            SELECT
                o."product_type_one",
                o."product_type_two",
