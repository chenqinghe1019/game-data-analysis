    ...
    SELECT
        ...
        CASE
            ...
            ELSE concat(
                ...
                cast(x."最早付费offset" + 1 AS varchar),
                '-D',
                cast(x."最早付费offset" + 7 AS varchar)
            )
        END "7日观察窗口",
    ...
    (
        SELECT
            ...
            CASE
                ...
                WHEN y."开放日活跃人数" = 0 THEN '开放日无活跃玩家'
                ELSE '可评估'
            END "评估状态"
        ...
        (
            ...
            (
                ...
                (
                    SELECT
                        ...
                        count(
                            DISTINCT concat(
                                cast(try_cast("product_id" AS bigint) AS varchar),
                                '_',
            ...
            (
               ...
               AND a."active_offset" = o."最早付费offset"
